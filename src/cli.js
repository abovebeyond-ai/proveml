...
Usage:
  ...
  npx proveml review --facts facts.json --evidence subjects.json [--snapshots dir] [--committed review.json] [--output page.html] [--manifests dir] [--brand-name vera --brand-mark "(^_^)"]
